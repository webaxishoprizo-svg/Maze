...
const Accessories = () => {
  ...
  const { products: mappedProducts, loading } = useProductsByCategory("accessories");
  ...
  useEffect(() => {
    document.title = "Accessories | Maze - Luxury Scarves, Shoes & More";
  }, []);
      ...
      <section className="pt-32 pb-16 lg:pt-40 lg:pb-20">
        <div className="container mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <h1 className="text-display-lg font-serif mb-6">Accessories</h1>
            <p className="text-body text-muted-foreground">
              Complete your look with our curated selection of luxury accessories, from silk scarves to designer footwear.
            </p>
          </motion.div>
        </div>
      </section>
