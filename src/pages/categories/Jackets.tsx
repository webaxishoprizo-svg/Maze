...
const Jackets = () => {
  ...
  const { products: mappedProducts, loading } = useProductsByCategory("jackets");
  ...
  useEffect(() => {
    document.title = "Jackets | Maze - Luxury Coats & Blazers";
  }, []);
      ...
      <section className="pt-32 pb-16 lg:pt-40 lg:pb-20">
        <div className="container mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <h1 className="text-display-lg font-serif mb-6">Jackets & Coats</h1>
            <p className="text-body text-muted-foreground">
              Discover our collection of tailored blazers, wool coats, and statement outerwear pieces designed for timeless sophistication.
            </p>
          </motion.div>
        </div>
      </section>
