...
const Dresses = () => {
  ...
  const { products: mappedProducts, loading } = useProductsByCategory("dresses");
  ...
  useEffect(() => {
    document.title = "Dresses | Maze - Elegant Designer Dresses";
  }, []);
      ...
      <section className="pt-32 pb-16 lg:pt-40 lg:pb-20">
        <div className="container mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <h1 className="text-display-lg font-serif mb-6">Dresses</h1>
            <p className="text-body text-muted-foreground">
              Explore our collection of elegant designer dresses, from sophisticated midi dresses to stunning evening gowns.
            </p>
          </motion.div>
        </div>
      </section>
