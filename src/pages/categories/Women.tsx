...
const Women = () => {
    ...
    const { products: mappedProducts, loading } = useProductsByCategory("women");
    ...
    useEffect(() => {
        document.title = "Women's Collection | Maze - Luxury Performance Activewear";
    }, []);
    ...
    return (
        <main className="min-h-screen">
            ...
            {/* Hero */}
            <section className="pt-32 pb-16 lg:pt-40 lg:pb-20 bg-[#F4F1EA]">
                <div className="container mx-auto px-6 lg:px-12">
                    ...
                    >
                        ...
                        <h1 className="text-display-lg font-serif mb-6 uppercase tracking-tight">Women</h1>
                        <p className="text-body text-muted-foreground leading-relaxed">
                            Elegance meets power. Explore our curated selection of high-performance luxury activewear designed to empower the modern woman's lifestyle.
                        </p>
                    </motion.div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-6 lg:px-12">
                    {products.length === 0 ? (
                        <div className="text-center py-20">
                            <p className="text-muted-foreground">New products coming soon to the Women's collection.</p>
                        </div>
                    ) : (
                        <div
