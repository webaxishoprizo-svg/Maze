                ...
                >
                    ...
                    <div className="relative z-10 w-full">
                        <div className="text-center mb-12 mt-4">
                            ...
                            <h1 className="flex flex-col items-center justify-center text-display font-bold uppercase mb-4 leading-[1.1]">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            <div className="space-y-3">
                                <label className="text-[10px] uppercase font-black text-foreground block px-2">Account ID / Email</label>
                            ...
                            <div className="space-y-3">
                                <div className="flex justify-between items-end px-2">
                                    <label className="text-[10px] uppercase font-black text-foreground">Password</label>
                                    <button type="button" className="text-[9px] uppercase font-bold text-muted-foreground hover:text-foreground transition-all hover:underline underline-offset-4 decoration-border">Access Recovery</button>
                                </div>
                                <div className="relative group/input">
                                    <input
                                        type="password"
                        ...
                        <div className="mt-16 text-center pt-10 border-t border-border/40">
                            <p className="text-[10px] uppercase text-muted-foreground mb-8 font-black">No Profile Yet?</p>
                            <Link
                                to="/register"
                                className="inline-flex items-center gap-4 px-12 py-5 rounded-[1.25rem] border border-border text-[11px] font-black uppercase text-foreground hover:bg-foreground hover:text-background hover:scale-105 active:scale-95 transition-all duration-500 group/reg"
                            >
