...
const Knitwear = () => {
  ...
  const { products: mappedProducts, loading } = useProductsByCategory("knitwear");
  ...
  useEffect(() => {
    document.title = "Knitwear | Maze - Cashmere Sweaters & Cardigans";
  }, []);
      ...
      <section className="pt-32 pb-16 lg:pt-40 lg:pb-20">
        <div className="container mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <h1 className="text-display-lg font-serif mb-6">Knitwear</h1>
            <p className="text-body text-muted-foreground">
              Indulge in our luxurious knitwear collection featuring premium cashmere sweaters, merino wool pieces, and elegant cardigans.
            </p>
          </motion.div>
        </div>
      </section>
